...
WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Backpackcarry.allTheThings()_da9c16'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/div_Sauce Labs Backpackcarry.allTheThings()_33489d'))

WebUI.click(findTestObject('Object Repository/Page_Swag Labs/footer_TwitterFacebookLinkedIn 2023 Sauce L_f560ad'))
